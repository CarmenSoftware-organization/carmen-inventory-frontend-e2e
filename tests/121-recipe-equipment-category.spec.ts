...
const opts = {
  listPath: PATH,
  nameInputId: "rec-eq-cat-name",
  activeSwitchId: "rec-eq-cat-is-active",
  descriptionInputId: "rec-eq-cat-description",
};

test.describe("Recipe Equipment Category — Smoke & CRUD", () => {
  ...
  test(
    "TC-RECC-010001 หน้า list โหลดสำเร็จ",
    {
      annotation: [
        ...
        { type: "steps", description: "1. ไปที่ /operation-plan/recipe-equipment-category" },
        { type: "expected", description: "URL ตรงกับ /operation-plan/recipe-equipment-category; หน้า list โหลดสำเร็จโดยไม่ error" },
  ...
  test(
    ...
    {
      annotation: [
        { type: "preconditions", description: "Login เป็น carmensoftware.dev+admin@gmail.com; อยู่ที่ /operation-plan/recipe-equipment-category" },
        { type: "steps", description: "1. ไปที่ /operation-plan/recipe-equipment-category" },
  ...
  test(
    ...
    {
      annotation: [
        { type: "preconditions", description: "TC-RECC-030001 ผ่านแล้ว → record NAME มีอยู่ใน DB" },
  ...
  test(
    ...
    {
      annotation: [
        { type: "preconditions", description: "TC-RECC-040001 ผ่านแล้ว → record มี name = NAME_UPDATED" },
  ...
  test(
    ...
    {
      annotation: [
        { type: "preconditions", description: "TC-RECC-200002 ผ่านแล้ว → record NAME_UPDATED ยังคงมีอยู่ใน DB" },
