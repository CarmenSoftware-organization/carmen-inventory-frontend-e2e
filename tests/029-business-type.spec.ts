...
test.describe("Business Type — Smoke & CRUD", () => {
  ...
  test(
    ...
    {
      annotation: [
        { type: "preconditions", description: "TC-BT06 ผ่านแล้ว → record NAME มีอยู่ใน DB" },
  ...
  test(
    ...
    {
      annotation: [
        { type: "preconditions", description: "TC-BT07 ผ่านแล้ว → record มี name = NAME_UPDATED" },
  ...
  test(
    ...
    {
      annotation: [
        { type: "preconditions", description: "TC-BT13 ผ่านแล้ว → record NAME_UPDATED ยังคงมีอยู่ใน DB" },
