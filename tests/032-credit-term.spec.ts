...
test.describe("Credit Term — Smoke & CRUD", () => {
  ...
  test(
    ...
    {
      annotation: [
        { type: "preconditions", description: "Login เป็น carmensoftware.dev+admin@gmail.com; อยู่ที่ /config/credit-term" },
        { type: "steps", description: "1. ไปที่ /config/credit-term" },
  ...
  test(
    ...
    {
      annotation: [
        { type: "preconditions", description: "Login เป็น carmensoftware.dev+admin@gmail.com; อยู่ที่ /config/credit-term พร้อม add dialog เปิดอยู่" },
