...
test.describe("Unit — Smoke", () => {
  test(
    ...
    {
      annotation: [
        { type: "preconditions", description: "Login เป็น purchase@blueledgers.com ผ่าน auth fixture (createAuthTest)" },
  ...
  test(
    ...
    {
      annotation: [
        { type: "preconditions", description: "Login เป็น purchase@blueledgers.com; อยู่ที่ /config/unit" },
        { type: "steps", description: "1. ไปที่ /config/unit" },
