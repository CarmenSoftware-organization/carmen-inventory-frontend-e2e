...
#### Requestor / Department Staff
**Role**: Assigned department staff who can create purchase requests
**Responsibilities**: Create PRs for assigned locations, submit for approval, monitor request status, identify operational needs
**Goals**: Procure necessary supplies efficiently, stay within assigned location scope, ensure timely availability of needed items
**Pain Points**: Limited visibility beyond assigned locations, waiting for approvals, unclear request status, stockouts
**System Usage**: Create PRs for assigned locations, attach supporting documents, track request progress, check request status

**Examples**: F&B staff, housekeeping staff, maintenance staff, front office staff

#### Head Of Department / Department Manager
**Role**: Department-level approval authority with department-wide visibility
**Responsibilities**: Approve PRs from requestors in department, monitor department spending, escalate high-value requests, ensure compliance
**Goals**: Ensure proper budget utilization, maintain procurement compliance, timely approvals, control costs, maintain quality standards
**Pain Points**: Volume of approval requests, budget constraints, balancing speed with control, budget overruns, unauthorized purchases
**System Usage**: Review and approve department PRs, monitor department-wide spending, budget tracking, escalation workflows, generate reports

**Examples**: F&B Manager, Housekeeping Manager, Maintenance/Engineering Manager, Front Office Manager
...
#### Cost Controller
**Role**: Monitors and analyzes operational costs
**Responsibilities**: Cost analysis, budget monitoring, variance reporting, cost optimization, spend tracking, financial forecasting
**Goals**: Identify cost-saving opportunities, monitor spending trends, reduce operational costs, ensure ROI on purchases
**Pain Points**: Delayed reporting, manual data collection, lack of real-time cost visibility, difficulty tracking trends across departments
**System Usage**: Cost reports, spend analytics dashboards, budget variance analysis, cost allocation reports, trend analysis, department cost comparisons
...
#### IT Manager / Property Application Administrator
**Role**: Property-level application administrator and system manager
**Responsibilities**: System configuration, user management, role assignments, access control, system maintenance, data integrity, troubleshooting, training coordination
**Goals**: System uptime and reliability, data security and integrity, efficient user onboarding, smooth system operations
**Pain Points**: User access requests backlog, system configuration complexity, balancing security with usability, training diverse user groups
**System Usage**: User account management, role and permission configuration, department and location setup, system settings, audit log review, backup management, report configuration
