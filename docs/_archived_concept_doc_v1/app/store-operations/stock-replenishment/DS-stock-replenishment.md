...
| 1.1.0 | 2025-01-15 | Claude | Updated SRStatus enum to 5-value simplified model; Added SRStage enum with STAGE_TO_STATUS mapping; Added `stage` field to StoreRequisition interface |
