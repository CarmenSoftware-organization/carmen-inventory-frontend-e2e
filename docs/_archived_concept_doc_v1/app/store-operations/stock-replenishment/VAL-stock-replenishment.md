...
| VAL-FLD-020 | status | VALID SRStatus ENUM (draft, in_progress, completed, cancelled, voided) | Invalid status value |
| VAL-FLD-020b | stage | VALID SRStage ENUM (draft, submit, approve, issue, complete) | Invalid stage value |
