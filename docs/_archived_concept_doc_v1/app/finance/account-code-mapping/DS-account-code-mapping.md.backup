# Data Schema: Account Code Mapping
...
| entry_number | VARCHAR(50) | Yes | Auto-generated | Unique sequential entry number | JE-2025-001234 | Unique, format: JE-YYYY-NNNNNN |
...
| source_document_reference | VARCHAR(50) | No | NULL | Source document number | GRN-2025-00123 | For display/audit |
...
| memo | TEXT | No | NULL | Additional line notes | Supplier: ABC Foods, PO: PO-2025-001 | Max 1000 chars |
...
| reference_number | VARCHAR(100) | No | NULL | External reference | Invoice INV-2025-001 | For reconciliation |
| created_at | TIMESTAMPTZ | Yes | NOW() | Creation timestamp | 2025-11-12T10:30:00Z | Immutable |
| created_by | UUID | Yes | - | Creator user ID | 550e8400-... | Foreign key to users |
