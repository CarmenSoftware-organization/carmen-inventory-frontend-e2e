# DS-INV-OVW: Stock Overview Data Definition
...
|---------|------|--------|---------|
| 1.1.0 | 2025-11-19 | Documentation Team | Migrated from DS to DD format |
| 1.0.0 | 2025-11-15 | Documentation Team | Initial version |
...
This document provides comprehensive data schema documentation for the Stock Overview module. It includes entity-relationship diagrams, table structures, constraints, indexes, and data dictionaries for all entities used in the dashboard and stock overview functionality.

**Related Documents**:
- [BR-INV-OVW: Business Requirements](./BR-stock-overview.md)
- [UC-INV-OVW: Use Cases](./UC-stock-overview.md)
- [TS-INV-OVW: Technical Specification](./TS-stock-overview.md)
- [FD-INV-OVW: Flow Diagrams](./FD-stock-overview.md)
- [VAL-INV-OVW: Validations](./VAL-stock-overview.md)
