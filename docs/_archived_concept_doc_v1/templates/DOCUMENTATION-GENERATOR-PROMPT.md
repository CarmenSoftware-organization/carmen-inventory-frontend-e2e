...
Template: docs/app/template-module/template-sub-module/BR-template.md
Guidelines: docs/templates/USER-STORY-TEMPLATE.md
...
Template: docs/app/template-module/template-sub-module/UC-template.md
...
Template: docs/app/template-module/template-sub-module/TS-template.md
...
Template: docs/app/template-module/template-sub-module/DS-template.md
...
Template: docs/app/template-module/template-sub-module/FD-template.md
...
Template: docs/app/template-module/template-sub-module/VAL-template.md
