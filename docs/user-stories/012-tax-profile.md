...
| --- | --- | --- | --- |
| TC-TP01 | หน้า list โหลดสำเร็จ | High | Smoke |
| TC-TP02 | ปุ่ม Add แสดง | High | Smoke |
| TC-TP03 | ช่องค้นหาใช้งานได้ | Medium | Smoke |
| TC-TP04 | ค้นหาคำที่ไม่มีต้องแสดง empty state | Medium | Functional |
| TC-TP05 | บันทึกโดยไม่กรอกชื่อต้องแสดง error | High | Validation |
| TC-TP06 | สร้างรายการใหม่และปรากฏในตาราง | High | CRUD |
| TC-TP07 | แก้ไขชื่อและบันทึก | High | CRUD |
| TC-TP08 | ลบรายการ | High | CRUD |
| TC-TP13 | แก้ไข: clear name แล้วบันทึก ต้องแสดง error | Medium | Validation |
| TCS-TP09 | XSS payload ในชื่อต้องไม่รัน script | High | Security |
| TCS-TP10 | SQL injection payload ต้องไม่ทำให้ระบบ crash | High | Security |
| TCS-TP11 | ชื่อยาวเกิน maxLength ต้องถูกจำกัดที่ 100 | Medium | Validation |
| TCS-TP12 _(skipped)_ | user สิทธิ์ต่ำเข้าหน้านี้ต้องไม่เห็นปุ่ม Add หรือถูก redirect | High | Authorization |
...
TC-TP06 ผ่านแล้ว → tax profile ชื่อ NAME มีอยู่ใน DB
...
TC-TP13 ผ่านแล้ว → tax profile ชื่อ NAME_UPDATED ยังคงมีอยู่ใน DB
...
TC-TP07 ผ่านแล้ว → tax profile ชื่อ NAME_UPDATED มีอยู่ใน DB
...
## TCS-TP09 — XSS payload ในชื่อต้องไม่รัน script
...
## TCS-TP10 — SQL injection payload ต้องไม่ทำให้ระบบ crash
...
## TCS-TP11 — ชื่อยาวเกิน maxLength ต้องถูกจำกัดที่ 100
...
## TCS-TP12 — user สิทธิ์ต่ำเข้าหน้านี้ต้องไม่เห็นปุ่ม Add หรือถูก redirect _(skipped)_
