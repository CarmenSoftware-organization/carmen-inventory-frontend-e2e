...
_Generated from `tests/008-department.spec.ts` annotations. Edit annotations, not this file. Regenerate with `bun docs:user-stories`._

**Module:** Department
**Spec:** `tests/008-department.spec.ts`
...
| --- | --- | --- | --- |
| TC-DEP01 | หน้า list โหลดสำเร็จ | High | Smoke |
| TC-DEP02 | ปุ่ม Add แสดง | High | Smoke |
| TC-DEP03 | ช่องค้นหาใช้งานได้ | Medium | Smoke |
| TC-DEP04 | ค้นหาคำที่ไม่มีต้องแสดง empty state | Medium | Functional |
| TC-DEP05 | บันทึกโดยไม่กรอก code/name ต้องแสดง error | High | Validation |
| TC-DEP06 | สร้างรายการใหม่และปรากฏในตาราง | High | CRUD |
| TC-DEP07 | แก้ไขชื่อและบันทึก | High | CRUD |
| TC-DEP08 | ลบรายการ | High | CRUD |
| TC-DEP13 | แก้ไข: clear code/name แล้วบันทึก ต้องแสดง error | Medium | Validation |
| TCS-DEP09 | XSS payload ในชื่อต้องไม่รัน script | High | Security |
| TCS-DEP10 | SQL injection payload ต้องไม่ทำให้ระบบ crash | High | Security |
| TCS-DEP11 | ชื่อยาวเกิน maxLength ต้องถูกจำกัดที่ 100 | Medium | Validation |
| TCS-DEP12 _(skipped)_ | user สิทธิ์ต่ำเข้าหน้านี้ต้องไม่เห็นปุ่ม Add หรือถูก redirect | High | Authorization |
...
TC-DEP06 ผ่านแล้ว → record CODE/NAME มีอยู่ใน DB
...
TC-DEP13 ผ่านแล้ว → record NAME_UPDATED ยังคงมีอยู่ใน DB
...
TC-DEP07 ผ่านแล้ว → record มี name = NAME_UPDATED
...
## TCS-DEP09 — XSS payload ในชื่อต้องไม่รัน script
...
## TCS-DEP10 — SQL injection payload ต้องไม่ทำให้ระบบ crash
...
## TCS-DEP11 — ชื่อยาวเกิน maxLength ต้องถูกจำกัดที่ 100
...
## TCS-DEP12 — user สิทธิ์ต่ำเข้าหน้านี้ต้องไม่เห็นปุ่ม Add หรือถูก redirect _(skipped)_
