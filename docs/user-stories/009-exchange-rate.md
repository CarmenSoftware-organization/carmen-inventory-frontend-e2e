...
| --- | --- | --- | --- |
| TC-ER01 | หน้า list โหลดสำเร็จ | High | Smoke |
| TC-ER02 | ปุ่ม Add แสดง | Medium | Smoke |
| TCS-ER09 | XSS payload ในชื่อต้องไม่รัน script | High | Security |
| TCS-ER10 | SQL injection payload ในช่องค้นหาต้องไม่ crash | High | Security |
| TCS-ER11 | ค้นหาด้วย string ยาวมากต้องไม่ crash | Medium | Validation |
| TCS-ER12 | user สิทธิ์ต่ำเข้าหน้านี้ต้องไม่เห็นปุ่ม Add หรือถูก redirect | High | Authorization |
...
## TCS-ER09 — XSS payload ในชื่อต้องไม่รัน script
...
## TCS-ER10 — SQL injection payload ในช่องค้นหาต้องไม่ crash
...
## TCS-ER11 — ค้นหาด้วย string ยาวมากต้องไม่ crash
...
## TCS-ER12 — user สิทธิ์ต่ำเข้าหน้านี้ต้องไม่เห็นปุ่ม Add หรือถูก redirect
