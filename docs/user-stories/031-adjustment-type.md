...
| --- | --- | --- | --- |
| TC-AT00101 | หน้า list โหลดสำเร็จ | High | Smoke |
| TC-AT00102 | ปุ่ม Add แสดง | High | Smoke |
| TC-AT00103 | ช่องค้นหาใช้งานได้ | Medium | Smoke |
| TC-AT00104 | ค้นหาคำที่ไม่มีต้องแสดง empty state | Medium | Functional |
| TC-AT00105 | บันทึกโดยไม่กรอก code/name ต้องแสดง error | High | Validation |
| TC-AT00106 | สร้างรายการใหม่ (Stock In) และปรากฏในตาราง | High | CRUD |
| TC-AT00107 | แก้ไขชื่อและบันทึก | High | CRUD |
| TC-AT00108 | ลบรายการ (Stock In) | High | CRUD |
| TC-AT00109 | สร้างรายการใหม่ (Stock Out) และปรากฏในตาราง | High | CRUD |
| TC-AT00110 | ลบรายการ (Stock Out) | High | CRUD |
| TC-AT00115 | แก้ไข: clear code/name แล้วบันทึก ต้องแสดง error | Medium | Validation |
| TCS-AT00111 | XSS payload ในชื่อต้องไม่รัน script | High | Security |
| TCS-AT00112 | SQL injection payload ต้องไม่ทำให้ระบบ crash | High | Security |
| TCS-AT00113 | ชื่อยาวเกิน maxLength ต้องถูกจำกัดที่ 100 | Medium | Validation |
| TCS-AT00114 _(skipped)_ | user สิทธิ์ต่ำเข้าหน้านี้ต้องไม่เห็นปุ่ม Add หรือถูก redirect | High | Authorization |
...
TC-AT00106 ผ่านแล้ว → record CODE/NAME มีอยู่ใน DB
...
TC-AT00115 ผ่านแล้ว → record CODE ยังคงมีอยู่ใน DB
...
TC-AT00109 ผ่านแล้ว → record CODE_OUT มีอยู่ใน DB
...
TC-AT00107 ผ่านแล้ว → record มี name = NAME_UPDATED
...
## TCS-AT00111 — XSS payload ในชื่อต้องไม่รัน script
...
## TCS-AT00112 — SQL injection payload ต้องไม่ทำให้ระบบ crash
...
## TCS-AT00113 — ชื่อยาวเกิน maxLength ต้องถูกจำกัดที่ 100
...
## TCS-AT00114 — user สิทธิ์ต่ำเข้าหน้านี้ต้องไม่เห็นปุ่ม Add หรือถูก redirect _(skipped)_
