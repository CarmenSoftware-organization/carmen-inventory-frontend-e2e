...
_Generated from `tests/701-sr.spec.ts` annotations. Edit annotations, not this file. Regenerate with `bun docs:user-stories`._

**Module:** Store Requisition
**Spec:** `tests/701-sr.spec.ts`
...
Login เป็น carmensoftware.dev+purchase@gmail.com มี role Requestor ถูก assign ให้ department และมีสิทธิ์เข้าถึง source location อย่างน้อยหนึ่งแห่ง
...
Login เป็น carmensoftware.dev+requestor@gmail.com แต่ไม่ถูก assign ให้ department ใด
...
Login เป็น carmensoftware.dev+requestor@gmail.com มี role Storekeeper requisition อยู่ใน In Progress status item รอ approval และผู้ใช้มีสิทธิ์เข้าถึง
