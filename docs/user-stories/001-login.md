...
| --- | --- | --- | --- |
| TC-L00101 | Requestor เข้าสู่ระบบสำเร็จ | High | Smoke |
| TC-L00102 | HOD เข้าสู่ระบบสำเร็จ | High | Smoke |
| TC-L00103 | Purchase เข้าสู่ระบบสำเร็จ | High | Smoke |
| TC-L00104 | FC เข้าสู่ระบบสำเร็จ | High | Smoke |
| TC-L00105 | GM เข้าสู่ระบบสำเร็จ | High | Smoke |
| TC-L00106 | Owner เข้าสู่ระบบสำเร็จ | High | Smoke |
| TC-L00107 | TT (user ไม่มี department) login ต้องแสดง dialog แจ้งยังไม่กำหนด department | High | Auth-guard |
| TC-L00108 | Requestor ออกจากระบบสำเร็จ | High | Smoke |
| TC-L00109 | HOD ออกจากระบบสำเร็จ | High | Smoke |
| TC-L00110 | Purchase ออกจากระบบสำเร็จ | High | Smoke |
| TC-L00111 | FC ออกจากระบบสำเร็จ | High | Smoke |
| TC-L00112 | GM ออกจากระบบสำเร็จ | High | Smoke |
| TC-L00113 | Owner ออกจากระบบสำเร็จ | High | Smoke |
| TC-L00114 | แสดง error เมื่อไม่กรอกรหัสผ่าน | Medium | Validation |
| TC-L00115 | แสดง error เมื่อไม่กรอกอีเมล | Medium | Validation |
| TC-L00116 | แสดง error เมื่อไม่กรอกข้อมูลทั้งสองช่อง | Low | Validation |
| TC-L00117 | แสดง error เมื่อรูปแบบอีเมลไม่ถูกต้อง | Medium | Validation |
| TC-L00118 | แสดง error เมื่อ credentials ไม่ถูกต้อง | Medium | Validation |
| TC-L00119 | แสดง error เมื่ออีเมลถูกแต่รหัสผ่านผิด | Medium | Validation |
| TC-L00120 | อีเมลไม่สนใจตัวพิมพ์ใหญ่-เล็ก | Medium | Functional |
| TC-L00121 | รหัสผ่านแยกตัวพิมพ์ใหญ่-เล็ก (พิมพ์ผิดเคสต้อง fail) | Medium | Validation |
| TC-L00122 | รองรับช่องว่างหน้า/หลังอีเมล | Low | Functional |
| TC-L00123 | ช่องรหัสผ่านถูก mask | Low | Functional |
| TC-L00124 | กด Enter เพื่อ submit form ได้ | Medium | Functional |
| TC-L00125 | เข้า route ที่ต้อง login โดยไม่ login ต้อง redirect ไปหน้า login | High | Auth-guard |
| TC-L00126 _(skipped)_ | user ที่ login แล้วเข้า /login ต้อง redirect ไป dashboard | Medium | Auth-guard |
| TC-L00127 | อีเมลแบบ SQL injection ต้องถูก reject อย่างปลอดภัย | High | Security |
| TC-L00128 | อีเมลแบบ XSS ต้องถูก reject อย่างปลอดภัย | High | Security |
| TC-L00129 | login username ผิดต้องได้รับ HTTP 401 | High | Security |
| TC-L00130 | login ชื่อเดิมผิด 3 ครั้ง ต้องได้รับ HTTP 429 | High | Security |
| TC-L00131 | StoreManager เข้าสู่ระบบสำเร็จ | High | Smoke |
| TC-L00132 | Budget เข้าสู่ระบบสำเร็จ | High | Smoke |
| TC-L00133 | StoreManager ออกจากระบบสำเร็จ | High | Smoke |
| TC-L00134 | Budget ออกจากระบบสำเร็จ | High | Smoke |

---

## TC-L00101 — Requestor เข้าสู่ระบบสำเร็จ
...
## TC-L00102 — HOD เข้าสู่ระบบสำเร็จ
...
## TC-L00103 — Purchase เข้าสู่ระบบสำเร็จ
...
## TC-L00104 — FC เข้าสู่ระบบสำเร็จ
...
## TC-L00105 — GM เข้าสู่ระบบสำเร็จ
...
## TC-L00106 — Owner เข้าสู่ระบบสำเร็จ
...
## TC-L00108 — Requestor ออกจากระบบสำเร็จ
...
## TC-L00109 — HOD ออกจากระบบสำเร็จ
...
## TC-L00110 — Purchase ออกจากระบบสำเร็จ
...
## TC-L00113 — Owner ออกจากระบบสำเร็จ
...
## TC-L00126 — user ที่ login แล้วเข้า /login ต้อง redirect ไป dashboard _(skipped)_
...
## TC-L00131 — StoreManager เข้าสู่ระบบสำเร็จ
...
User storemanager@blueledgers.com exists and is active; browser is logged out
...
## TC-L00132 — Budget เข้าสู่ระบบสำเร็จ
...
User budget@blueledgers.com exists and is active; browser is logged out
...
## TC-L00133 — StoreManager ออกจากระบบสำเร็จ
...
## TC-L00134 — Budget ออกจากระบบสำเร็จ
