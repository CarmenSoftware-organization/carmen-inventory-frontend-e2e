...
_Generated from `tests/301-pr.spec.ts` annotations. Edit annotations, not this file. Regenerate with `bun docs:user-stories`._

**Module:** Purchase Request
**Spec:** `tests/301-pr.spec.ts`
**Default role:** Requestor
**Total test cases:** 132 (95 High / 28 Medium / 9 Low)
...
| TC-PR-010050 | active BU = BLAVG | High | Smoke |
...
Login เป็น Requestor (carmensoftware.dev+requestor@gmail.com); อยู่ที่หน้า list
...
> **As a** Requestor user, **I want** core Purchase Request interactions to work, **so that** day-to-day usage stays smooth.
