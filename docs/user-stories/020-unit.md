...
| TC-UN-100002 | SQL injection payload ในช่องค้นหาต้องไม่ crash | High | Security |
| TC-UN-100003 | ค้นหาด้วย string ยาวมากต้องไม่ crash | Medium | Validation |
| TC-UN-100004 | user สิทธิ์ต่ำเข้าหน้านี้ต้องไม่เห็นปุ่ม Add หรือถูก redirect | High | Authorization |
...
Login เป็น purchase@blueledgers.com ผ่าน auth fixture (createAuthTest)
...
Login เป็น purchase@blueledgers.com; อยู่ที่ /config/unit
...
## TC-UN-100002 — SQL injection payload ในช่องค้นหาต้องไม่ crash
...
## TC-UN-100003 — ค้นหาด้วย string ยาวมากต้องไม่ crash
...
## TC-UN-100004 — user สิทธิ์ต่ำเข้าหน้านี้ต้องไม่เห็นปุ่ม Add หรือถูก redirect
