...
| --- | --- | --- | --- |
| TC-UN00101 | หน้า list โหลดสำเร็จ | High | Smoke |
| TC-UN00102 | ปุ่ม Add แสดง | High | Smoke |
| TC-UN00103 | ช่องค้นหาใช้งานได้ | Medium | Smoke |
| TC-UN00104 | ค้นหาคำที่ไม่มีต้องแสดง empty state | Medium | Functional |
| TCS-UN00109 | XSS payload ในชื่อต้องไม่รัน script | High | Security |
| TCS-UN00110 | SQL injection payload ในช่องค้นหาต้องไม่ crash | High | Security |
| TCS-UN00111 | ค้นหาด้วย string ยาวมากต้องไม่ crash | Medium | Validation |
| TCS-UN00112 | user สิทธิ์ต่ำเข้าหน้านี้ต้องไม่เห็นปุ่ม Add หรือถูก redirect | High | Authorization |
...
## TCS-UN00109 — XSS payload ในชื่อต้องไม่รัน script
...
## TCS-UN00110 — SQL injection payload ในช่องค้นหาต้องไม่ crash
...
## TCS-UN00111 — ค้นหาด้วย string ยาวมากต้องไม่ crash
...
## TCS-UN00112 — user สิทธิ์ต่ำเข้าหน้านี้ต้องไม่เห็นปุ่ม Add หรือถูก redirect
