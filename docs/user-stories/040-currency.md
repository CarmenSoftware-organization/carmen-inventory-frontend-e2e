...
| --- | --- | --- | --- |
| TC-CUR00101 | หน้า list โหลดสำเร็จ | High | Smoke |
| TC-CUR00102 | ปุ่ม Add แสดง | High | Smoke |
| TC-CUR00103 | ช่องค้นหาใช้งานได้ | Medium | Smoke |
| TC-CUR00104 | ค้นหาคำที่ไม่มีต้องแสดง empty state | Medium | Functional |
| TC-CUR00105 | บันทึกโดยไม่กรอกชื่อต้องแสดง error | High | Validation |
| TC-CUR00106 | สร้างรายการใหม่และปรากฏในตาราง | High | CRUD |
| TC-CUR00107 | แก้ไขชื่อและบันทึก | High | CRUD |
| TC-CUR00108 | ลบรายการ | High | CRUD |
| TC-CUR00113 | แก้ไข: clear name แล้วบันทึก ต้องแสดง error | Medium | Validation |
| TCS-CUR00109 | XSS payload ในชื่อต้องไม่รัน script | High | Security |
| TCS-CUR00110 | SQL injection payload ต้องไม่ทำให้ระบบ crash | High | Security |
| TCS-CUR00111 | ชื่อยาวเกิน maxLength ต้องถูกจำกัดที่ 100 | Medium | Validation |
| TCS-CUR00112 _(skipped)_ | user สิทธิ์ต่ำเข้าหน้านี้ต้องไม่เห็นปุ่ม Add หรือถูก redirect | High | Authorization |
...
TC-CUR00106 ผ่านแล้ว → record NAME มีอยู่ใน DB
...
TC-CUR00113 ผ่านแล้ว → record NAME_UPDATED ยังคงมีอยู่ใน DB
...
TC-CUR00107 ผ่านแล้ว → record มี name = NAME_UPDATED
...
## TCS-CUR00109 — XSS payload ในชื่อต้องไม่รัน script
...
## TCS-CUR00110 — SQL injection payload ต้องไม่ทำให้ระบบ crash
...
## TCS-CUR00111 — ชื่อยาวเกิน maxLength ต้องถูกจำกัดที่ 100
...
## TCS-CUR00112 — user สิทธิ์ต่ำเข้าหน้านี้ต้องไม่เห็นปุ่ม Add หรือถูก redirect _(skipped)_
