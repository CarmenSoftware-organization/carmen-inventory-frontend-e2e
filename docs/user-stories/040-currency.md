...
Login เป็น purchase@blueledgers.com; อยู่ที่ /config/currency
...
Login เป็น purchase@blueledgers.com; เปิด add dialog ของ /config/currency
...
Login เป็น purchase@blueledgers.com; record NAME ยังไม่มีอยู่ใน DB; ISO code IDR เลือกได้จาก lookup
