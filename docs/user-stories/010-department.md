...
Login เป็น purchase@blueledgers.com; อยู่ที่ /config/department
...
Login เป็น purchase@blueledgers.com; อยู่ที่ /config/department/new
...
TC-DEP-010006 ผ่านแล้ว → record CODE/NAME มีอยู่ใน DB
