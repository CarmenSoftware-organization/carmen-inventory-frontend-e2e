...
| --- | --- | --- | --- |
| TC-VEN00101 | หน้า list โหลดสำเร็จ | High | Smoke |
| TC-VEN00102 | ปุ่ม Add แสดง | High | Smoke |
| TC-VEN00103 | ช่องค้นหาใช้งานได้ | Medium | Smoke |
| TC-VEN00104 | ค้นหาคำที่ไม่มีต้องแสดง empty state | Medium | Functional |
| TC-VEN00105 | Filter status (active/inactive) ใช้งานได้ | Medium | Functional |
| TC-VEN00106 | เปิดหน้า new form สำเร็จ | High | Smoke |
| TC-VEN00107 | เลือก business type จาก dropdown ได้ | Medium | Functional |
| TC-VEN00108 | สร้าง vendor ขั้นต่ำ (code + name + business type) สำเร็จ | High | CRUD |
| TC-VEN00109 | สร้าง vendor พร้อม address 1 รายการ | High | CRUD |
| TC-VEN00110 | สร้าง vendor พร้อม contact 1 รายการ (primary) | High | CRUD |
| TC-VEN00111 | สลับ tab ทั้ง 4 tabs ได้ | Medium | Functional |
| TC-VEN00112 | เพิ่ม address row ได้หลาย row | Medium | Functional |
| TC-VEN00113 | ลบ address row ได้ | Medium | Functional |
| TC-VEN00114 | เพิ่ม contact row ได้หลาย row | Medium | Functional |
| TC-VEN00115 | ลบ contact row ได้ | Medium | Functional |
| TC-VEN00116 | เปลี่ยน primary contact ได้ (radio exclusive) | Medium | Functional |
| TC-VEN00117 | เพิ่ม info row (label/value) ได้ | Medium | Functional |
| TC-VEN00118 | ลบ info row ได้ | Medium | Functional |
| TC-VEN00119 | บันทึกโดยไม่กรอก code ต้องแสดง error | High | Validation |
| TC-VEN00120 | บันทึกโดยไม่กรอก name ต้องแสดง error | High | Validation |
| TC-VEN00121 | code เกิน 10 ตัวอักษรต้องถูก reject | Medium | Validation |
| TC-VEN00122 | name เกิน 100 ตัวอักษรต้องถูก reject | Medium | Validation |
| TC-VEN00123 | address ที่ไม่มีทั้ง city และ district ต้อง fail (refinement) | Medium | Validation |
| TC-VEN00124 | contact email รูปแบบผิดต้องแสดง error | Medium | Validation |
| TC-VEN00125 | แก้ name ของ vendor ที่สร้างแล้ว save สำเร็จ | High | CRUD |
| TC-VEN00126 | เปิด delete dialog ของ vendor แล้ว cancel — row ยังอยู่ | Medium | Functional |
| TC-VEN00127 | ลบ vendor ที่สร้างในชุด test สำเร็จ (cleanup หลัก) | High | CRUD |
| TC-VEN00128 | หลังลบแล้วค้นหาไม่พบ row นั้นอีก | Medium | Functional |
...
TC-VEN00108 ผ่านแล้ว → vendor ที่ NAME มีอยู่ใน DB; logged in as purchase@blueledgers.com
...
TC-VEN00125 ผ่านแล้ว → vendor ที่ NAME_UPDATED มีอยู่ใน DB
...
TC-VEN00126 ผ่านแล้ว → vendor ที่ NAME_UPDATED ยังคงอยู่ใน DB
...
TC-VEN00127 ผ่านแล้ว → vendor ที่ NAME_UPDATED ถูกลบจาก DB แล้ว
