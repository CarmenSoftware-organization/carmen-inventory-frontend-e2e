...
| --- | --- | --- | --- |
| TC-BT-010001 | หน้า list โหลดสำเร็จ | High | Smoke |
...
> **As a** Admin user, **I want** the Business Type list page to load successfully, **so that** I can manage Business Type records.
...
> **As a** Admin user, **I want** to see the Add button on the Business Type list, **so that** I can create new records.
...
> **As a** Admin user, **I want** to type into the Business Type search field, **so that** I can quickly locate existing records.
...
> **As a** Admin user, **I want** a clear empty-state when no Business Type records match my search, **so that** I know nothing was found.
...
## TC-BT-100001 — XSS payload ในชื่อต้องไม่รัน script
...
## TC-BT-100002 — SQL injection payload ต้องไม่ทำให้ระบบ crash
...
## TC-BT-100003 — ชื่อยาวเกิน maxLength ต้องถูกจำกัดที่ 100
...
## TC-BT-100004 — user สิทธิ์ต่ำเข้าหน้านี้ต้องไม่เห็นปุ่ม Add หรือถูก redirect _(skipped)_
